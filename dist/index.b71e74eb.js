...
})({"fCpIl":[function(require,module,exports) {
"use strict";
...
class User extends (0, _model.Model) {
    ...
    static buildUserCollection() {
        return new (0, _collection.Collection)("http://localhost:3000/users", (json)=>User.buildUser(json));
    }
    setRandomAge() {
...
},{"./ApiSync":"3wylh","./Attributes":"6Bbds","./Collection":"dD11O","./Eventing":"7459s","./Model":"f033k","@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"3wylh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class ApiSync {
    ...
    //will have id
    fetch(id) {
        return (0, _axiosDefault.default).get(`http://localhost:3000/users/${id}`);
    }
    save(data) {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"gmWhz":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Attributes", ()=>Attributes) //downside with current get()-> get returns just string, number
...
class Attributes {
    constructor(data){
        this.data = data;
        this.// get(propName: string): (string | number) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"dD11O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Collection {
    constructor(rootUrl, deserialize){
        ...
        this.//K is for UserProps, value hasnt always have to be UserProps
        models = [];
...
},{"axios":"jo6P5","./Eventing":"7459s","@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"7459s":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"f033k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Model {
    ...
    //reason: the class vars must be used in shorthand syntax, not lke this.events= new Events() 
    ...
    fetch() {
        ...
        if (typeof id !== "number") throw new Error("cannt fetch without id");
        else this.sync.fetch(id).then((res)=>{
            this.set(res.data);
        });
    }
    save() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"mUs49":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./CollectionView":"4BOou","./UserShow":"2Tlyi","@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"4BOou":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"2Tlyi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./View":"5Vo78","@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}],"5Vo78":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    constructor(parent, model){
        this.parent = parent;
        this.model = model;
        this.//Model requires UserProps type generic type, so the above syntax
        //first K is a ref to 2nd K
        regions = {};
        this.//rerender dom when change is triggred
        bindModel = ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gmWhz"}]},["fCpIl","h7u1C"], "h7u1C", "parcelRequireed00")
